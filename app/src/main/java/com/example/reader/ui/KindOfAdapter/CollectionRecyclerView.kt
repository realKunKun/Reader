...
class CollectionRecyclerView (val context: Context, var bookList: ArrayList<NovelDataModel.Book>): RecyclerView.Adapter<CollectionRecyclerView.ViewHolder>() {
